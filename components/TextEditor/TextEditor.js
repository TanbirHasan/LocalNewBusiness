...
// class CustomOptionCom extends Component {
//   static propTypes = {
...
//     const data = this.state.editorState.getCurrentContent().getPlainText();
//     setData(data);
...
//           toolbarCustomButtons={[<CustomOptionCom />, <CustomTable />]}
