const AboutUsSecond = () => {
  return (
    <div className="px-10 xl:px-20 lg:px-20 py-20">
      <h3 className="Tagline mb-5 text-[#D16F32] text-start xl:text-start md:text-start lg:text-start ">
        ABOUT US
      </h3>
      <div className="flex flex-col xl:flex-row lg:flex-row">
        <div className="w-full xl:w-2/4 lg:w-2/4 sm:w-full">
          <h2 className="headline1 mb-5 text-[24px] lg:text-[52px] xl:text-[52px] md:text-[52px]  sm:mb-5 xl:text-start lg:text-start">
            Be the first to access new companies contact details with new start
            data.
          </h2>
        </div>
        <div className="w-full text-[24px] lg:w-2/4 xl:w-2/4">
          <p className="headline6 text-[12px] lg:text-[18px] md:text-[18px]">
            ...
            companies contact details with New Start Data. Be the first to
            access new companies contact details. Be the first to access new
            companies contact details with New Start Data. Be the first to
            access new companies accesss Learn More...
          </p>
        </div>
      </div>
    </div>
